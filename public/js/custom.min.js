jQuery(document).ready(function($) {
    ...
    $('div.shaved10x > p').attr('style', '').hide();
    $('div.shaved10x > p:first-child').show();
    $('div.shaved10x > p:first-child').shave(100);

    $('div.shaved20x > p').attr('style', '').hide();
    $('div.shaved20x > p:first-child').show();
    $('div.shaved20x > p:first-child').shave(200);

    $('div.shaved05x > p').attr('style', '').hide();
    $('div.shaved05x > p:first-child').show();
    $('div.shaved05x > p:first-child').shave(50);

    $('div.shaved02x > p').attr('style', '').hide();
    $('div.shaved02x > p:first-child').show();
    $('div.shaved02x > p:first-child').shave(25);

    //markindown
    //todo
    //tweetlinking
    var x = document.getElementsByClassName("tweetlinker");
    console.log(x);
    var i;
    ...
    function attWorkGrid_2() {
        if ($('#gallery-grid-1-masonrywrap').length) {
            ...
            var handler = jQuery('#gallery-grid-1-masonrywrap li');
...
function initMap(){
    //CONTACT MAP
    if (jQuery('#map_contact_2').length) {
        var map;
        var myLatLng = new google.maps.LatLng(9.988597, 76.280876);
        //Initialize MAP
        var myOptions = {
            zoom: 17,
            center: myLatLng,
    ...
    //EVENT DETAIL MAP
    if (jQuery('#map_contact_1').length) {
        var map;
